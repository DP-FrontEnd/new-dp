...
window.averta = {}, function (n) {
    ...
    window.package = function (n) {
        ...
        window._jcsspfx = e(), window._csspfx = i[window._jcsspfx], window._cssanim = o(), window._css3d = s(), window._css2d = u(), window._mobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), window._touch = "ontouchstart" in document
    ...
    "use strict";
    var t = "ontouchstart" in document, r = !1, o = r ? "MSPointerDown" : t ? "touchstart" : "mousedown",
        u = r ? "MSPointerMove" : t ? "touchmove" : "mousemove", f = r ? "MSPointerUp" : t ? "touchend" : "mouseup",
        e = r ? "MSPointerUp" : "touchcancel", i;
    ...
    n.changeTo = function (n, t, i, r, u) {
        if (this.stopped = !1, this._internalStop(), n = this._checkLimits(n), i = Math.abs(i || 0), this.options.snapping && (r = r || this.getSnapNum(n), u !== !1 && this._callsnapChange(r), this.current_snap = r), t) {
            this.animating = !0;
            var f = this, e = ++f.__animID, c = n - f.value, l = 0, a = n, o, s = 1 - f.options.friction,
                h = function () {
                    if (e === f.__animID) {
                        var t = n - f.value;
    ...
    MSLayerEffects.setup = function () {
        if (!i) {
            i = !0;
            var r = MSLayerEffects, u = window._jcsspfx + "Transform", f = window._jcsspfx + "TransformOrigin",
                e = n.browser.opera;
    ...
    window.MSLayerElement = function () {
        this.$cont = n("<div><\/div>").addClass("layer-cont"), this.start_anim = {
            ...
            duration: 1e3,
            ease: "linear"
        }, this.type = "text", this.swipe = !0, this.resizable = !0, this.minWidth = -1, this.__cssConfig = ["margin-top", "padding-top", "margin-bottom", "padding-left", "margin-right", "padding-right", "margin-left", "padding-bottom", "left", "right", "top", "bottom", "font-size", "line-height"], this.baseStyle = {}
    };
    ...
    t.__playAnimation = function (n, t) {
        ...
        var n, t, i;
        for (this.initialized = !0, this.$element.css("visibility", ""), t = 0, i = this.__cssConfig.length; t < i; t++)n = this.$element.css(this.__cssConfig[t]), n != "auto" && n != "" && n != "normal" && (this.baseStyle[this.__cssConfig[t]] = parseInt(n))
    }, t.locate = function () {
    ...
    t._showTT = function () {
        ...
        var i = this.tt.outerHeight(), n = Math.max(this.tt.outerWidth(), parseInt(this.tt.css("max-width"))),
    ...
    this.type = n
}, MSSliderEvent.CHANGE_START = "changeStart", MSSliderEvent.CHANGE_END = "changeEnd", MSSliderEvent.WATING = "wating", MSSliderEvent.AUTOPLAY_CHANGE = "autoplayChange", MSSliderEvent.VIDEO_PLAY = "videoPlay", MSSliderEvent.VIDEO_CLOSE = "videoClose", MSSliderEvent.INIT = "init", function (n) {
    "use strict";
    ...
    t.onSwipeStart = function () {
        ...
        this.ready = !0, this.slider.api._startTimer(), this.selected && (this.initLayers(), this.locateLayers(), this.startLayers(), this.vinit && (this.bgvideo.play(), this.autoPauseBgVid || (this.bgvideo.currentTime = 0))), this.isSleeping || this.setup(), CTween.fadeOut(this.$loading, 300, !0), (this.slider.options.preload === 0 || this.slider.options.preload === "all") && this.index < this.view.slideList.length - 1 ? this.view.slideList[this.index + 1].loadImages() : this.slider.options.preload === "all" && this.index === this.view.slideList.length - 1 && this.slider._removeLoading()
        ...
        if (this.bgLoaded = !0, this.$bg_img.css("visibility", ""), n.browser.msie) this.$bg_img.on("dragstart", function (n) {
            n.preventDefault()
        });
        ...
        var t, n, i;
        if (!this.ls) {
            for (this.ls = !0, this.hasBG && this.bg_src && (t = this, this.$bg_img.preloadImg(this.bg_src, function () {
                t._onBGLoad()
        ...
        this.hasLayers && (this.$element.append(this.$layers), this.slider.options.layersMode == "center" && this.$layers.css("max-width", this.slider.options.width + "px")), this.link && this.$element.css("cursor", "pointer").click(function () {
            ...
            t.__closeVideo()
        }).appendTo(this.$element).css("display", "none"), window._touch && this.vcbtn.removeClass("ms-slide-vcbtn").addClass("ms-slide-vcbtn-mobile").append('<div class="ms-vcbtn-txt">Close video<\/div>').appendTo(this.view.$element.parent())), this.slider.options.autoHeight || (this.$imgcont.css("height", "100%"), (this.fillMode === "center" || this.fillMode === "stretch") && (this.fillMode = "fill")), this.sleep()
    }, t.destroy = function () {
    ...
    window.MasterSlider = function () {
    ...
    }, MasterSlider.author = "Averta Ltd. (www.averta.net)", MasterSlider.version = "1.5.0", MasterSlider.releaseDate = "February 2014", t = MasterSlider.prototype, t.__setupSlides = function () {
        var i = this, t, r = 0;
        ...
        return this.$element.addClass("master-slider").addClass("before-init"), n.browser.msie && this.$element.addClass("ms-ie").addClass("ms-ie" + n.browser.version.slice(0, n.browser.version.indexOf("."))), r = navigator.userAgent.toLowerCase(), u = r.indexOf("android") > -1, u && this.$element.addClass("ms-android"), f = this, n.extend(this.options, i), n(document).ready(function () {
            f._init()
        }), this.aspect = this.options.width / this.options.height, this.$loading = n("<div><\/div>").addClass("ms-loading-container").insertBefore(this.$element).append(n("<div><\/div>").addClass("ms-loading")), this.$loading.parent().css("position", "relative"), this.options.autofill && (this.options.fullwidth = !0, this.options.fullheight = !0), this.options.fullheight && this.$element.addClass("ms-fullheight"), this._resize(), this
    }, t.destroy = function () {
    ...
    t.__snapCompelet = function () {
        ...
        if (!this.normalMode) {
            var r = Math.floor(this.options.viewNum / 2), t = this.viewSlidesList.indexOf(this.slideList[this.index]),
                i = this[this.__dimension] + this.spacing, n = this.options.critMargin;
            if (this.loop) {
        ...
        var t = [], n = 0, i = this.slidesCount / 2, r = this.slidesCount % 2 == 0 ? i - 1 : Math.floor(i),
        ...
        this.__created = !0, this.index = n || 0, this.loop && (this.slides = this.__createLoopList()), this.normalMode = this.slidesCount <= this.options.viewNum, this.__locateSlides();
    ...
    n.__updateSlidesHoriz = function (n, t) {
        var i = Math.abs(t * 100 / this.__width), r = Math.min(i * 30 / 100, 30) * (t < 0 ? -1 : 1), u = i * 120 / 100;
    ...
    i.extend(BaseControl), t = i.prototype, r = BaseControl.prototype, t.setup = function () {
        ...
        var r = n(t.$element.find(".ms-thumb")), u = this,
